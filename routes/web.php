 ...
 // MIDDLEWARE WILL APPLAY ON BELOW GROUPED ROUTES
    Route::group(['middleware' => ['auth:admin']], function () {
        ...
        Route::controller(BatchController::class)->group(function () {
            ...
            Route::post('updateBatchPopular', 'updateBatchPopular')->name('updateBatchPopular');
        ...
        Route::controller(NotificationController::class)->group(function () {
            Route::match(['get', 'post'], 'notificationManage', 'notificationManage')->name('notificationManage');
            Route::post('notificationList', 'notificationList')->name('notificationList');
            Route::post('updateNotificationStatus', 'updateNotificationStatus')->name('updateNotificationStatus');
