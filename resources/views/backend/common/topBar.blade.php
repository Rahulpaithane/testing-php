...
<div class="edu_admin_header_info">
    ...
    <div class="edu_admin">
        <div class="edu_admin_inner">
                ...
                <a class="edu_admin_bar" href="javascript:void(0);"> <span class="icofont-user-alt-4"></span>Admin
                    ...
                    <a href="{{ route($shared['routePath'].'.profile')}}"><i class="icofont-user"></i>Profile</a>
                                    <a href="{{ route($shared['routePath'].'.signOut')}}" title="Logout" class=""><i class="icofont-logout"></i><span>Logout</span></a>
            </div>
        </div>
    </div>
</div>
