<div class="row">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        ...
        <div class="edu_color_boxes box_left">
            ...
            <div class="edu_dash_info">
                <ul>
                    <li><p>Active <span>{{$students->where('status', 1)->count()}}</span></p></li>
                    <li><p>Inactive <span>{{$students->where('status', 0)->count()}}</span></p></li>
                </ul>
            </div>
        </div>
        </a>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        ...
        <div class="edu_color_boxes box_left">
            ...
            <div class="edu_dash_info">
                <ul>
                    <li><p>Active <span>{{$teachers->where('status', 1)->count()}}</span></p></li>
                    <li><p>Inactive <span>{{$teachers->where('status', 0)->count()}}</span></p></li>
                </ul>
            </div>
        </div>
        </a>
        ...
        {{-- <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        <a href="{{ route($shared['routePath'].'.teachersList')}}">
        <div class="edu_color_boxes box_left">
            <div class="edu_dash_box_data">
                <p>Total Teachers</p>
                <h3>{{$teachers->count()}}</h3>
            ...
            <div class="edu_dash_info">
                <ul>
                    <li><p>Present <span>0</span></p></li>
                    <li><p>Absent <span>0</span></p></li>
                </ul>
            </div>
        </div>
        </a>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        ...
        <div class="edu_color_boxes box_left">
            ...
            <div class="edu_dash_info">
                <ul>
                    <li><p>Active Govt <span>{{$classes->where('prepration', 'Govt')->where('status', 1)->count()}}</span></p></li>
                    {{-- <li><p>Active Govt <span>{{$classes->where('prepration', 'Govt')->where('status', 0)->count()}}</span></p></li> --}}
                    <li><p>Active School <span>{{$classes->where('prepration', 'School')->where('status', 1)->count()}}</span></p></li>
                    {{-- <li><p>InActive School <span>{{$classes->where('prepration', 'School')->where('status', 1)->count()}}</span></p></li> --}}
                </ul>
            </div>
        </div>
        </a>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        ...
        <div class="edu_color_boxes box_center">
            ...
            <div class="edu_dash_info">
                <ul>
                    <li><p>Active <span>{{$batches->where('status', 1)->count()}}</span></p></li>
                    <li><p>Inactive <span>{{$batches->where('status', 0)->count()}}</span></p></li>
                </ul>
            </div>
        </div>
        </a>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        ...
        <div class="edu_color_boxes box_center">
            ...
            <div class="edu_dash_info">
                <ul>
                    <li><p>Physical <span>{{$books->where('book_type', 'Physical')->count()}}</span></p></li>
                    <li><p>E-Book <span>{{$books->where('book_type', 'E-Book')->count()}}</span></p></li>
                </ul>
            </div>
        </div>
        </a>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        <a href="{{ route($shared['routePath'].'.questionBankList')}}">
            <div class="edu_color_boxes box_right">
                ...
                <div class="edu_dash_info">
                    <ul>
                        <li><p>English <span>{{$questions->where('language_type', 'English')->count()}}</span></p></li>
                        <li><p>Hindi <span>{{$questions->where('language_type', 'Hindi')->count()}}</span></p></li>
                        <li class="ml-2 mr-2 " style="border-left:2px solid rgb(240, 236, 236); height:20px;"><p>  &nbsp; Both <span>{{$questions->where('language_type', 'Both')->count()}}</span></p></li>
                    </ul>
                </div>
            </div>
        </a>
    ...
    {{-- <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="edu_color_boxes box_other">
            ...
            <div class="edu_dash_info">
                <ul>
                    <li><p> <a href="{{ asset('admin/manage-student-leave')}}">Student <span>7</span></a></p></li>
                    <li><p> <a href="{{ asset('admin/manage-teacher-leave')}}">Teacher <span>0</span></a></p></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
        <a href="{{ asset('admin/doubts-classes')}}">
        <div class="edu_color_boxes box_other">
            <div class="edu_dash_box_data">
                <p>Doubts</p>
                <h3>358</h3>
            ...
            <div class="edu_dash_info">
                <ul>
                    <li><p>Approved <span>1</span></p></li>
                    <li><p>Pending <span>357</span></p></li>
                </ul>
            </div>
        </div>
        </a>
