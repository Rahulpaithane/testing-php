...
@section('papgeTitle', 'Create Paper')
            ...
            <div class="footer_popup_inner">
                ...
                <div class="fp_btn_wrpa">
                    <div class="edu_addPaper_wrap">
                        <a class="edu_admin_btn showCreatePaperModal mr-2"><i class="icofont-plus"></i>Create Paper</a>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Create Paper</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>

        <!-- Modal body -->
        <div class="modal-body">
            <form data="{{ route($shared['routePath'].'.insertPaper') }}" id="insertFormData"  method="POST" enctype="multipart/form-data">
            {{-- <form action="{{ route($shared['routePath'].'.insertPaper') }}"   method="POST" enctype="multipart/form-data"> --}}
				...
				<div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12 col-12">
						<div class="form-group">
							<label>Language Type <sup>*</sup></label>
							<select class="form-control " name="languageType" id="languageType" require >
								<option value="English">English</option>
								<option value="Hindi">Hindi</option>
                                <option value="Both">Both</option>
							</select>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12 col-12">
						<div class="form-group">
							...
							<select class="form-control " name="isLive" id="isLive" require >
